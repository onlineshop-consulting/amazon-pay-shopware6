...
class TransactionService
{
    ...
    /**
     * @param EntityRepository $amazonPayTransactionRepository
     * @param EntityRepository $orderTransactionRepository
     * @param EntityRepository $orderRepository
     * @param OrderTransactionStateHandlerInterface $orderTransactionStateHandler
    ...
    public function persistAmazonPayTransaction(StructBase $transactionStruct, Context $context, ?OrderTransactionEntity $orderTransaction = null, $parentTransaction = null, ?string $salesChannelId = null): void
    {
        ...
        if (!isset($transaction)) {
            throw new \Exception('Invalid Transaction Type ' . $transactionStruct::class);
        }
    ...
    protected function getChargePermissionTransaction(ChargePermission $chargePermission, ?Context $context = null, ?string $salesChannelId = null): AmazonPayTransactionEntity
    {
        return $this->getAmazonPayTransactionEntity(
            ...
            ->setAmount((float)$chargePermission->getLimits()->getAmountLimit()->getAmount())
            ->setCapturedAmount((float)$chargePermission->getLimits()->getAmountLimit()->getAmount() - (float)$chargePermission->getLimits()->getAmountBalance()->getAmount())
