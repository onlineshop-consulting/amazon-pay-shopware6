...
class AmazonPayOrderController extends AbstractController
{
    ...
    public function fetchPaymentDetails(Request $request, Context $context, string $chargePermissionId): JsonResponse
    {
        ...
        foreach ($charges as $charge) {
            ...
            if (\in_array($charge->getStatus(), [StatusDetails::AUTHORIZED, StatusDetails::AUTHORIZATION_INITIATED], true)) {
            ...
            foreach ($refunds as $refund) {
                ...
                if (\in_array($refund->getStatus(), [StatusDetails::REFUND_INITIATED, StatusDetails::REFUNDED], true)) {
