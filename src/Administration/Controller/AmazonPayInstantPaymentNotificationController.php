...
class AmazonPayInstantPaymentNotificationController extends AbstractController
{
    ...
    public function paymentNotification(Request $request, Context $context): Response
    {
        ...
        try {
            ...
            if ($notificationHandler = $this->paymentNotificationHandlerRegistry->getHandler($notificationMessage->getObjectType())) {
                ...
                $this->logger->debug('🌐❌ Payment notification ignored', ['notificationId' => $notificationMessage->getNotificationId()]);
            }
