...
{
    public const REQUEST_PARAMETER_REVIEW_RETURN_URL = 'reviewReturnUrl';
    public const REQUEST_PARAMETER_RETURN_URL = 'returnUrl';
    public const REQUEST_PARAMETER_AMAZON_CHECKOUT_SESSION_ID = 'amazonCheckoutSessionId';
    public const REQUEST_PARAMETER_ORDER_TRANSACTION_ID = 'orderTransactionId';
    ...
    public function purePayment(Request $request, SalesChannelContext $context): AmazonPayRouteResponse
    {
        try {
            ...
            $responseData = new ArrayStruct(['error' => $e->getMessage(), 'errorType' => $e::class]);
        }
        $response = new AmazonPayRouteResponse($responseData);
    ...
    public function purePaymentFinalize(Request $request, SalesChannelContext $salesChannelContext): AmazonPayRouteResponse
    {
        try {
