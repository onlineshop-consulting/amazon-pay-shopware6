...
Component.register('swag-amazon-pay-charge-modal', {
    ...
    methods: {
        ...
        getCharge() {
            return this.paymentDetails.charges[this.chargeId]
                ? this.paymentDetails.charges[this.chargeId].details
                : null;
        },
        ...
        onConfirm() {
            if (
                ...
                !Number.isFinite(this.chargeAmount || this.chargeAmount === 0)
            ) {
                this.chargeAmount = this.chargeAmountLimit;
            }
                ...
                .then((response) => {
                    if (!response.chargeId) {
                        ...
                        this.createNotificationSuccess({
                            ...
                            message: this.$tc(
                                'swag-amazon-pay-order.charge-modal.notification.success',
                                0,
                                {
