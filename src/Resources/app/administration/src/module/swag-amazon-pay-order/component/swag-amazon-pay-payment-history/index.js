            ...
            return [
                {
                    ...
                    dataIndex: 'type',
                    label: this.$tc(
                        'swag-amazon-pay-order.payment-history.columns.subject'
                    ),
                    primary: true,
                },
                {
                    ...
                    dataIndex: 'reference',
                    label: this.$tc(
                        'swag-amazon-pay-order.payment-history.columns.objectId'
                    ),
                },
                {
                    property: 'amount',
                    dataIndex: 'amount',
                    label: this.$tc(
                        'swag-amazon-pay-order.payment-history.columns.amount'
                    ),
                },
                {
                    property: 'status',
                    ...
                    align: 'center',
                    label: this.$tc(
                        'swag-amazon-pay-order.payment-history.columns.status'
                    ),
                },
                {
                    property: 'time',
                    dataIndex: 'time',
                    label: this.$tc(
                        'swag-amazon-pay-order.payment-history.columns.date'
                    ),
                },
                {
                    property: 'actions',
                    dataIndex: 'actions',
                    label: this.$tc(
                        'swag-amazon-pay-order.payment-history.columns.actions'
                    ),
                },
            ];
        },
