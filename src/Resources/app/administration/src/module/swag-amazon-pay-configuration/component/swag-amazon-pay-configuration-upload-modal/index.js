        ...
        onSubmit(ignoreVersionMismatch = false) {
            ...
            if (!this.selectedFile) {
                this.createNotificationError({
                    ...
                    message: this.$tc(
                        'swag-amazon-pay-configuration.importModal.notification.noFileSelected'
                    ),
                });
            ...
            this.SwagAmazonPayConfigService.importConfig(
                this.selectedFile,
                ...
                .then((response) => {
                    ...
                    this.createNotificationSuccess({
                        ...
                        message: this.$tc(
                            'swag-amazon-pay-configuration.importModal.notification.success'
                        ),
                    });
                ...
                .catch(() => {
                    ...
                    this.createNotificationError({
                        ...
                        message: this.$tc(
                            'swag-amazon-pay-configuration.importModal.notification.error'
                        ),
                    });
                });
        },
